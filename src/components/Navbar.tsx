        ...
        >
          {siteConfig.logoUrl ? (
            <img 
              ...
              className="w-[30px] h-[35px] rounded-lg object-contain bg-gray-900/60 p-0.5 border border-blue-500/30 group-hover:border-blue-400 transition" 
            />
          ) : (
            <div className="w-[30px] h-[35px] rounded-lg bg-gradient-to-br from-blue-600 to-indigo-700 flex items-center justify-center font-black text-xs text-white shadow-lg shadow-blue-500/20 group-hover:scale-105 transition">
              NG
            </div>
          )}
          <div>
